-- TruxPylot scale-safe indexes. Additive only; no production data is modified or deleted.
CREATE INDEX IF NOT EXISTS "User_role_status_createdAt_idx" ON "User"("role", "status", "createdAt");
CREATE INDEX IF NOT EXISTS "User_createdAt_idx" ON "User"("createdAt");
CREATE INDEX IF NOT EXISTS "Professional_verificationStatus_createdAt_idx" ON "Professional"("verificationStatus", "createdAt");
CREATE INDEX IF NOT EXISTS "Professional_state_city_idx" ON "Professional"("state", "city");
