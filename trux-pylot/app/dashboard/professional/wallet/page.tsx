    ...
    <main className="dash-page wallet-dashboard">
      ...
      <section className="wallet-command-grid">
        ...
        <div className="wallet-stack" id="wallet-money-out">
          ...
          <section className="wallet-panel wallet-panel-modern">
            <div className="wallet-panel-head"><div><span className="wallet-step">04</span><div><h2>Withdraw funds</h2><p>Request a payout from your available balance.</p></div></div><span className="wallet-secure">MIN ₦2,000</span></div>
