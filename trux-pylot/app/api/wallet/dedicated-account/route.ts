...
export async function GET(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({ accountNumber: account.accountNumber, accountName: account.accountName, bankName: account.bankName, bankSlug: account.bankSlug, lastSyncedAt: account.lastSyncedAt });
